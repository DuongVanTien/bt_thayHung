...
public class MyTest {
    ...
    public boolean testNgaythangnam(String ngaythangnam) {
        if(ngaythangnam.equalsIgnoreCase("")){
            return true;
        }
    ...
    public boolean testTungayDenngay(String tungay, String denngay) {
        ...
        if(myTest.testNgaythangnam(tungay) && myTest.testNgaythangnam(denngay)
                && tungay.equalsIgnoreCase("") || tungay==null || tungay.isEmpty()
...
//            System.out.println("namthangngay : "+namDenngay+"/"+thangDenngay+"/"+ngayDenngay);
            ...
            if(namTungay > namDenngay){
                JOptionPane.showMessageDialog(null, "Fail. Năm từ ngày lơn hơn năm đến ngày");
                return false;
            }
            
            if(namTungay==namDenngay && thangTungay>thangDenngay){
                JOptionPane.showMessageDialog(null, "Fail. Tháng từ ngày lớn hơn tháng đến ngày");
                return false;
            }
            
            if(namTungay==namDenngay  && thangTungay==thangDenngay && ngayTungay>ngayDenngay){
                JOptionPane.showMessageDialog(null, "Fail. Từ ngày lớn hơn đến ngày");
                return false;
            }
            JOptionPane.showMessageDialog(null, "OK. Text field từ ngày đến ngày thỏa mãn");
            return true;
        } 
        return false;
    }
